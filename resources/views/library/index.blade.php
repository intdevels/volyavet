        ...
        <section class="library-page">
            ...
            <div class="library-page__inner">
                <div class="library-page__btns">
                    <a href="#" class="library-page__btn">
                    ...
                    <a href="#" class="library-page__btn active">
                ...
                <div class="posts">
                    <div class="post">
                        ...
                        <div class="post-content">
                            <div class="post-default">
                                ...
                                <div class="post-date">16.06.23</div>
                            </div>
                    ...
                    <div class="post">
                        ...
                        <div class="post-content">
                            <div class="post-default">
                                <div class="post-title">
                                    О чём говорит сонливость питомца
                                </div>
                                <div class="post-date">16.06.23</div>
                            </div>
                            <div class="post-hover">
                    ...
                    <div class="post">
                        ...
                        <div class="post-content">
                            <div class="post-default">
                                <div class="post-title">
                                    Запишитесь на весенний чек-ап здоровья питомца
                                </div>
                                <div class="post-date">16.06.23</div>
                            </div>
                            <div class="post-hover">
                    ...
                    <div class="post">
                        ...
                        <div class="post-content">
                            <div class="post-default">
                                <div class="post-title">
                                    Виды правильных кормов для вашего хомяка
                                </div>
                                <div class="post-date">16.06.23</div>
                            </div>
                            <div class="post-hover">
                    ...
                    <div class="post">
                        ...
                        <div class="post-content">
                            <div class="post-default">
                                <div class="post-title">
                                    Отель для животных - реальность в VolyaVet
                                </div>
                                <div class="post-date">16.06.23</div>
                            </div>
                            <div class="post-hover">
